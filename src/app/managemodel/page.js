...
export default function ModelPage() {
    ...
    return (
        <Box sx={{ 
                    ...
                    <CardContent sx={{ p: 3 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                <ModelTrainingIcon sx={{ color: '#861F41', mr: 1, fontSize: 28 }} />
                                ...
                                <Table>
                                    <TableHead>
                                        <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                                            ...
                                            <TableCell sx={{ fontWeight: 'bold' }}>Input Fields</TableCell>
                                        ...
                                        {models.length > 0 ? (
                                            models.map((model) => (
                                                ...
                                                >
                                                    ...
                                                    <TableCell>
                                                        {model.filePath && model.filePath !== 'No file uploaded' ? (
                                                            <Tooltip title={model.filePath}>
                                                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                                                    <FileIcon color="primary" fontSize="small" sx={{ mr: 1 }} />
                                            ...
                                            <TableRow>
                                                <TableCell colSpan={5} align="center" sx={{ py: 4 }}>
                                                    <Box sx={{ textAlign: 'center', py: 3 }}>
                                                        <ModelTrainingIcon sx={{ fontSize: 48, color: '#C95B0C', mb: 2 }} />
            ...
            >
                <DialogTitle id="edit-model-dialog-title" sx={{ color: '#1a237e', fontWeight: 'bold' }}>
                    Edit Model
                </DialogTitle>
                <DialogContent>
                        ...
                        {editDialog.file ? (
                            <Box sx={{ width: '100%' }}>
                                ...
                                <Typography variant="body2" color="primary">
                                    New file selected ({(editDialog.file.size / 1024 / 1024).toFixed(2)} MB)
                                </Typography>
                            </Box>
                        ) : (
                            <>
