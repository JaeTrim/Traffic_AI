...
export default function ReportsPage() {
  ...
  useEffect(() => {
    const groupPredictionsByModel = async () => {
      ...
      const groups = {};
      const tempInfo = {};
      const ids = [...new Set(collection.predictions.map((p) => p.modelId))];
              ...
              <Box>
                ...
                >
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                    <Typography variant="body1">Total Predictions:</Typography>
                    <Chip
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <TableCell>
                                      <Chip
                                        label={
                                          prediction.sourceType || "Manual"
                                        }
                                        size="small"
                                        color={
                                          prediction.sourceType === "csv"
                                            ? "secondary"
                                            : "default"
                                        }
                                        variant="outlined"
