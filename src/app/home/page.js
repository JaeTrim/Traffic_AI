        ...
        >
            <CardContent sx={{ p: 4 }}>
                ...
                {loading ? (
                    ...
                    <Card sx={{ p: 4, textAlign: 'center', backgroundColor: '#f5f5f5', borderRadius: 2 }}>
                    ...
                    <TableContainer component={Paper} elevation={1} sx={{ borderRadius: 2 }}>
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Collection Name</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Created Date</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Predictions</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Actions</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {collections.map((collection) => (
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <Chip 
                                                label={collection.predictions ? collection.predictions.length : 0} 
                                                color={collection.predictions && collection.predictions.length > 0 ? "primary" : "default"}
                                                size="small"
                                            />
                                        </TableCell>
                                        <TableCell>
                                            <Box sx={{ display: 'flex', gap: 1 }}>
                                                ...
                                                <IconButton
                                                    color="error"
                                                    size="small"
                                                    onClick={() => onDeleteCollection(collection._id, collection.collectionName)}
                                                >
                                                    <DeleteIcon />
                                                </IconButton>
                                            </Box>
...
function UIUserLog() {
    ...
    return (
        <Card elevation={3} sx={{ borderRadius: 2, overflow: 'hidden' }} data-component="user-log">
            <CardContent sx={{ p: 0 }}>
            <Box sx={{ 
                p: 3, 
                ...
                {/*display errors*/}
                {error && (
                    <Box sx={{ p: 2, backgroundColor: '#ffebee', borderColor: '#ffcdd2', borderStyle: 'solid', borderWidth: 1 }}>
                ...
                {loading ? (
                    ...
                    <TableContainer component={Paper} elevation={0}>
                        <Table sx={{ minWidth: 650 }}>
                            <TableHead>
                                <TableRow>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Timestamp</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Model</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Input Source</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', backgroundColor: '#e8eaf6' }}>Predictions</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
